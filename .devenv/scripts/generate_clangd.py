...
1. 既定（リポジトリルートを自動判定し `.clangd` を上書き）
   python3 .devenv/scripts/generate_clangd.py
2. 出力先を明示
   python3 .devenv/scripts/generate_clangd.py --output /path/to/.clangd
...
def parse_args() -> argparse.Namespace:
    # スクリプト配置:
    #   <repo>/.devenv/scripts/generate_clangd.py
...
def render_clangd(
    ...
    lines: List[str] = []
    lines.append("# This file is auto-generated by .devenv/scripts/generate_clangd.py")
    if conflicts:
